    ...
    if data == "back_home":
        ...
        if prod_type == "outline":
            ...
            if links:
                ...
                add_usage(gb_val)
                add_history(user_id, {"oid": "WEB", "product": "Outline VPN", "qty": 1, "total": 0, "date": date_str})
            else:
            ...
            if links:
                ...
                add_usage(gb_val)
                add_history(user_id, {"oid": "WEB", "product": "Hiddify VPN", "qty": 1, "total": 0, "date": date_str})
            else:
