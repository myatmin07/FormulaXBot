...
# ဖိုင်များကို ပြိုင်တူရေး/ဖတ်ခြင်းမှ ကာကွယ်ရန် Lock
...
# ==========================================
# 3. HELPER FUNCTIONS (Thread Safe)
# ==========================================
def load_json(filepath, default_data):
    ...
    with file_lock:
        try:
            ...
            # File Corrupt ဖြစ်လျှင် Reset အတင်းမလုပ်တော့ပါ။ ပုံမှန်အတိုင်းသာ ဆက်သွားမည်။
            return dict(default_data)
...
def load_products(): 
    ...
    for k, v in default_products.items():
        if k not in data:
            ...
            # အမည်ပြောင်းလဲခြင်းသာ Update လုပ်မည်။ ဈေးနှုန်းနှင့် Stock ကို လုံးဝ ဝင်မရှုပ်ပါ။
