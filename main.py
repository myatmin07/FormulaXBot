    ...
    for prod_id, duration, price, title in prod_list:
        ...
        if stock:
            if prod_id in ["spotify_2", "spotify_3"]:
                ...
                btn_text = f"Buy {title} | {price:,} MMK | {tg_emoji('5382194935057372936', '⏳')} {days_left} Days Left"
            else:
...
def query_handler(call):
    ...
    if data == "back_home":
        ...
        summary += f"{tg_emoji('5801018335919347111', '📌')} Note: <b>PAYMENT</b>\n\n"
